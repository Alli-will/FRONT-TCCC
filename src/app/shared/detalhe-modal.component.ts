...
@Component({
  ...
  template: `
    ...
    <div class="modal-content" role="dialog" aria-modal="true" tabindex="-1">
      <button class="close-btn" (click)="close()" aria-label="Fechar">&times;</button>
      <ng-container *ngIf="detalhe">
        ...
        <div *ngIf="detalhe.tipo === 'video'">
          <ng-container *ngIf="detalhe.conteudo && detalhe.conteudo.includes('youtube.com')">
            <iframe
          ...
          <ng-container *ngIf="detalhe.conteudo && !detalhe.conteudo.includes('youtube.com')">
            <video controls [src]="detalhe.conteudo" style="max-width:100%;width:100%"></video>
          </ng-container>
          <div *ngIf="detalhe.descricao" class="detalhe-descricao">
            {{ detalhe.descricao }}
          </div>
